            ...
            <form action="{{ route('admin.delivery-zones.store') }}" method="POST">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Delivery Zone</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="name"
                                        ...
                                        placeholder="e.g. Zone 1 - Within 2.5 miles" value="{{ old('name') }}" required>
                                    @error('name')
                            ...
                            {{-- <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" id="min_distance" name="min_distance"
                                        ...
                                        placeholder="e.g. 0" value="{{ old('min_distance') }}" required>
                                    @error('min_distance')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" id="max_distance" name="max_distance"
                                        ...
                                        placeholder="e.g. 2.50" value="{{ old('max_distance') }}" required>
                                    @error('max_distance')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" id="delivery_fee" name="delivery_fee"
                                        ...
                                        placeholder="e.g. 2.50" value="{{ old('delivery_fee') }}" required>
                                    @error('delivery_fee')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" id="minimum_order_amount"
                                        ...
                                        placeholder="e.g. 15.00" value="{{ old('minimum_order_amount') }}" required>
                ...
                <div class="p-3 bg-light mb-3 rounded">
                    <div class="row justify-content-end g-2">
                        <div class="col-lg-2">
                            <button type="submit" class="btn btn-primary w-100">Create Delivery Zone</button>
                        </div>
                        <div class="col-lg-2">
