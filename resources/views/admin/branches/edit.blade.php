            ...
            <form action="{{ route('admin.branches.update', $branch->id) }}" method="POST">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update Branch Settings</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" value="{{ old('name', $branch->name) }}"
                                        name="name" class="form-control" placeholder="Branch Name">
                                    @error('name')
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="phone" value="{{ old('phone', $branch->phone) }}"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="email" value="{{ old('email', $branch->email) }}"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="address" value="{{ old('address', $branch->address) }}"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="currency_code"
                                        value="{{ old('currency_code', $branch->currency_code) }}" name="currency_code"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="currency_symbol"
                                        value="{{ old('currency_symbol', $branch->currency_symbol) }}"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" id="tax_percentage"
                                        value="{{ old('tax_percentage', $branch->tax_percentage) }}" name="tax_percentage"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" id="delivery_fee"
                                        value="{{ old('delivery_fee', $branch->delivery_fee) }}" name="delivery_fee"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" id="min_order_amount"
                                        value="{{ old('min_order_amount', $branch->min_order_amount) }}"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="estimated_delivery_time"
                                        value="{{ old('estimated_delivery_time', $branch->estimated_delivery_time) }}"
                                        name="estimated_delivery_time" class="form-control"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="estimated_pickup_time"
                                        value="{{ old('estimated_pickup_time', $branch->estimated_pickup_time) }}"
                                        name="estimated_pickup_time" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            {{ old('is_order_enabled', $branch->is_order_enabled) == 1 ? 'checked' : '' }}>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            {{ old('is_delivery_enabled', $branch->is_delivery_enabled) == 1 ? 'checked' : '' }}>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            {{ old('is_pickup_enabled', $branch->is_pickup_enabled) == 1 ? 'checked' : '' }}>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            {{ old('is_cod_enabled', $branch->is_cod_enabled) == 1 ? 'checked' : '' }}>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            {{ old('is_online_enabled', $branch->is_online_enabled) == 1 ? 'checked' : '' }}>
                                    </div>
